...
"<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\">";
            ...
            foreach (var controller in controllers)
            {
                ...
                .Where(method => method.IsDefined(typeof(SitemapIncludeAttribute)) || (method.IsPublic && !method.IsDefined(typeof(NonActionAttribute)) && typeof(IActionResult).IsAssignableFrom(method.ReturnType) && !method.IsDefined(typeof(SitemapExcludeAttribute)) && !Excluded))
                .Select(x => new SitemapItem { Controller = x.DeclaringType.Name.Replace("Controller", "", StringComparison.OrdinalIgnoreCase),
                    Action = x.Name,
